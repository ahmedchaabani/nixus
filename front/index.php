...
<head>
    <meta charset="utf-8">
    <title>Nixus - Job Portal Website Template</title>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="index.html" class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
                <h1 class="m-0 text-primary">Nixus</h1>
            </a>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Our posts</h1>
                <div class="row g-4">
                    <?php

                    // Instancier un objet du contrôleur du forum
                    $forumC = new forumC();

                    // Récupérer tous les articles par défaut
                    $var = $forumC->allforum();

                    // Vérifier si une recherche par titre a été effectuée
                    if (isset($_GET['search_title'])) {
                        // Capturer le terme de recherche
                        $searchTitle = $_GET['search_title'];

                        // Interroger la base de données pour récupérer les articles correspondants
                        $searchResults = $forumC->searchByTitle($searchTitle);

                        // Remplacer les articles par les résultats de la recherche
                    ...
                    <section class="blog-posts-area section-gap">
                        <div class="container">
                            ...
                            <a class="ticker-btn" href="http://localhost/forum/back/afficherab.php">Administration</a>
                            <br><br><br>
                            ...
                            <div class="row">
                                <div class="col-lg-8 post-list blog-post-list">
                                    ...
                                    foreach ($var as $row) {
                                            ...
                                            <div class="bottom-meta">
                                                ...
                                                <div class="user-details row align-items-center">
                                                    ...
                                                    <div class="social-wrap col-lg-6">
                                                        <ul>
                                                            <p><a
                                                                    href="edit_a.php?id=<?php echo $row['id'] ?>">Editer</i></a>
                                                            </p>
                                                            <p><a
                                                                    href="supprimer_a.php?id=<?php echo $row['id'] ?>">supprimer</i></a>
                                                            </p>
                                                        </ul>
                                                    </div>
                                                    <div class="bottom-meta">
                                                        <!-- Autres éléments de métadonnées ici -->
                                                        <div class="like-section">
                                                            <button class="like-btn"
                                                                onclick="likePost(<?php echo $row['id']; ?>)">
                                                                <i class="far fa-heart"></i> <!-- Icône de cœur vide -->
                                                                <span class="like-count"
                                                                    id="like-count-<?php echo $row['id']; ?>"><?php echo $row['likes']; ?></span>
                                                        ...
                                                        <script>
                                                            function likePost(postId) {
                                                                ...
                                                                var likeCount = parseInt(document.getElementById('like-count-' + postId).innerText);

                                                                // Vérifier si le post est déjà aimé
                                                                if (likeCount == 0) {
                                                                    // Si le post n'est pas aimé, incrémenter le nombre total de likes et mettre à jour l'élément HTML
                                                                    likeCount++;
                                                                    ...
                                                                    // Si le post est déjà aimé, décrémenter le nombre total de likes et mettre à jour l'élément HTML
                                                                    likeCount--;
                                                                    document.getElementById('like-count-' + postId).innerText = likeCount;
                                                ...
                                                <div class="comment-form-container">
                                                    <form class="comment-form" action="" method="post">
                                                        ...
                                                        <button type="submit" class="btn-submit-comment">Poster</button>
                                                    </form>
                                                </div>
                                                <br>
                                                <button onclick="toggleComments(<?php echo $row['id']; ?>)">Show Comments</button>
                                                <br><br>
                                            </div>
                                        </div>
                                        <?php
                                        // Vérifier si le formulaire d'ajout de commentaire a été soumis
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_SESSION['comment_submitted'])) {
                                            ...
                                            if (isset($_POST['post_id']) && isset($_POST['comment_content'])) {
                                                ...
                                                $success = $forumC->addComment($postId, $commentContent);
                                        ...
                                        <div id="comments-section-<?php echo $row['id']; ?>" style="display: none;">

                                            <h3>Commentaires</h3>
                                            <?php
                                            // Requête pour récupérer les commentaires associés à ce post
                                            $comments = $forumC->getCommentsByPostId($row['id']);
                                            ...
                                            if (!empty($comments)) {
                                                foreach ($comments as $comment) {
                                                    ...
                                                    echo "<form class='delete-comment-form' method='post'>";
                                                    echo "<input type='hidden' name='comment_id' value='{$comment['id']}'>";
                                                    echo "<button type='submit' class='delete-comment-btn'><i class='fa fa-trash'></i></button>";
                                                    echo "</form>";
                                                    echo "</div>";
                                                    echo "</div>";
                                                }
                                        ...
                                        <?php
                                        // Traitement de la suppression de commentaire côté serveur
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['comment_id'])) {
                                            // Récupérer l'ID du commentaire à supprimer depuis le formulaire
                                            $commentId = $_POST['comment_id'];

                                            // Supprimer le commentaire de la base de données en utilisant la fonction deleteComment de votre contrôleur
                                            $success = $forumC->deleteComment($commentId);
