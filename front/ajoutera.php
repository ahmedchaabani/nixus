<?php 
    // 
    include_once "../back/model/forum.php";
    include_once "../back/controller/forumC.php";
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Add post</h1>
                <div class="row g-4">
						...
						<div class="banner-content col-lg-12">
                            ...
                            <div class="col-lg-12">
								...
								<div class="col-lg-12">
									...
									<div class="col-lg-12">
                                        <label>Date</label>
                                        <input value="<?= $currentforum['date'] ?>" type="date" name="date"
                                            class="form-control">
                                    </div>
								</div>
								<div class="col-lg-12">
									<div class="form-group mrb-0">
										<button type="submit" class="btn btn-primary mt-3">Ajouter Une Poste</button>
    ...
    function validateForm() {
        ...
        if (titre.includes('pw1') || titre.includes('pw2') || titre.includes('pw3')) {
            alert('Le titre ne peut pas contenir "pw1", "pw2" ou "pw3". Veuillez en choisir un autre.');
            return false;
        }
        return true;
    }
