...
if(isset($_GET['id'])) {
    $ateC = new AtelierC();
    $atelier = $ateC->selectAtelier($_GET['id']);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="ClientAtelier.php" class="dropdown-item" >Afficher les formations</a>
    ...
    <div class="atelier-item">
        <h3><?php echo $atelier['nom_a'] ?></h3>

        <p>Dure: <?php echo $atelier['dure_a'] ?></p>
        <p>Description: <?php echo $atelier['description_a'] ?></p>
        <p>Formateur: <?php echo $atelier['formateur_a'] ?></p>
        <p>Niveau: <?php echo $atelier['niveau_a'] ?></p>
        <p>Id_user: <?php echo $atelier['id_user'] ?></p>
        <p>Id_formation: <?php echo $atelier['id_user'] ?></p>
        

        <div class="button-container">
            <button class="btn btn-primary w-100 py-3"><a href="ClientAtelier.php?id=<?php echo $row['id'] ?>">retourner</a></button>
        </div>
    </div>
</div>
