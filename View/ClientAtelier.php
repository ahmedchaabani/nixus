                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="ClientFormation.php" class="dropdown-item" >Afficher les ateliers</a>
...
<?php foreach ($result as $row) { ?>
    <div class="atelier-item">
        <h3><?php echo $row['nom_a'] ?></h3>

        <p>Type: <?php echo $row['dure_a'] ?></p>
        


        <div class="button-container">
            <button class="btn btn-primary w-100 py-3"><a href="Client2.php?id=<?php echo $row['id'] ?>">details</a></button>
        </div>
    </div>
<?php } ?>
</div>
