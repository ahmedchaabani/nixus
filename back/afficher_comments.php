                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">List of Comments</h4>
                                ...
                                <div class="table-responsive" id="det">
                                    <table class="table table-borderless align-middle table-nowrap mb-0">
                                        <thead>
                                            <tr>
                                                <th scope="col"><a href="afficher_comments.php?trier=id"><i
                                                            class="ri-sort-desc"></i> </a>ID</th>
                                                <th scope="col"><a href="afficher_comments.php?trier=post_id"><i
                                                            class="ri-sort-desc"></i> </a>Post ID</th>
                                                <th scope="col"><a href="afficher_comments.php?trier=content"><i
                                                            class="ri-sort-desc"></i> </a>Content</th>
                                                <th scope="col"><a href="afficher_comments.php?trier=date_added"><i
                                                            class="ri-sort-desc"></i> </a>Date Added</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="hstack gap-3 fs-15">
                                                            ...
                                                            <a href="supprimer_comments.php?id=<?php echo $row['id'] ?>"
