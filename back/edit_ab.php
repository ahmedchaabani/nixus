                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for=""></label>
                                            <input value="<?= $currentforum['categorie'] ?>" type="text" name="categorie"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label for=""></label>
                                            <input value="<?= $currentforum['titre'] ?>" type="text" name="titre"
                                                class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label for=""></label>
                                            <input value="<?= $currentforum['message'] ?>" type="text" name="message"
                                                class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label for=""></label>
                                            <input value="<?= $currentforum['image'] ?>" type="text" name="image"
                                                class="form-control">
